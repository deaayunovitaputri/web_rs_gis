    ...
    <footer className="bg-primary text-white py-12 relative overflow-hidden">
      <div className="container relative z-10">
        ...
        <div className="mt-12 pt-8 border-t border-white/20 text-center text-white/60 text-sm">
          <p>© {currentYear} Web GIS Rumah Sakit Surabaya. All rights reserved.</p>
        </div>
      </div>
      
      {/* Decorative circles */}
      <div className="decorative-circle w-64 h-64 bg-white opacity-5 rounded-full absolute -top-32 -left-32"></div>
      <div className="decorative-circle w-96 h-96 bg-white opacity-5 rounded-full absolute -bottom-48 -right-48"></div>
    </footer>
  );
}
