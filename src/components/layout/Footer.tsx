        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/privacy" className="text-white/80 hover:text-white">Kebijakan Privasi</Link></li>
              <li><Link href="/terms" className="text-white/80 hover:text-white">Syarat & Ketentuan</Link></li>
              <li><Link href="/contact" className="text-white/80 hover:text-white">Kontak Kami</Link></li>
            </ul>
          </div>
