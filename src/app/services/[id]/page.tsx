...
const sampleServices: Service[] = [/* sample data omitted for brevity */];
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="col-span-1">
                <label className="block text-sm font-medium text-gray-700 mb-2">Cari Rumah Sakit</label>
            ...
            <div className="mt-8">
              ...
              <ul className="space-y-4">
                {filteredHospitals.map(hospital => (
                  <li key={hospital.id} className="border p-4 rounded-lg shadow-sm">
                    <h3 className="text-lg font-semibold">{hospital.name}</h3>
                    <p className="text-sm text-gray-600">{hospital.address}</p>
                    <p className="text-sm text-gray-600">Telepon: {hospital.phone}</p>
